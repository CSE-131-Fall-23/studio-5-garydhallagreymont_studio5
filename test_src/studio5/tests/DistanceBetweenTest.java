...
public class DistanceBetweenTest {
	...
	public void testPointsA() {
		...
		assertEquals(1.0, Methods.distanceBetween(1.0, 0.0, 2.0, 0.0), 1);
	}
	...
	public void testPointsB() {
		...
		assertEquals(2.0, Methods.distanceBetween(0.0, 1.0, 0.0, -1.0), 2);
	}
	...
	public void testPointsC() {
		...
		assertEquals(5.0, Methods.distanceBetween(-1.0, -1.0, 2.0, 3.0), Math.sqrt(25));
	}
	...
	public void testPointsD() {
		...
		assertEquals(50.0, Methods.distanceBetween(0.0, 30.0, 0.0, 40.0), Math.sqrt(2500));
	}
	
	public void testPointsE() {
		assertEquals(5.0, Methods.distanceBetween(8.0, 5.0, 9.0, 5.0), Math.sqrt(25));
	}
